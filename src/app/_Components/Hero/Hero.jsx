    ...
    return (
        <div className='bg-[var(--accent)] pt-5 mt-[60px]'>
            <div className='bg-[var(--accent)] text-[var(--foreground)] font-reemakufi '>
                <p className='text-center text-3xl'>I'm Chamal Maduranga</p>
                <div className='flex text-[10px] justify-center gap-2 font-light font-poppins'>
                    {services.map((service, index) => (<p key={index}>| {service.title} | </p>))}
                </div>
            </div>

            <div className='flex justify-between h-[380px] pt-5'>
                <div className='font-poppins text-[11px] w-1/2 p-5'>I’m a passionate designer skilled in image retouching, graphic design, web design, and wedding photography. With an eye for detail and creativity, I combine artistic vision with the latest tools like Next.js and Tailwind CSS to build modern, responsive, and stylish websites. My work blends aesthetic appeal with functionality, ensuring every project leaves a lasting impression.</div>
